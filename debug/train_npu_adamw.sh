...
for model_name in "${models[@]}"; do
  ...
  python3 debug/main_adamw.py fit \
    ...
    --trainer.logger.name "npu-debug-fixedres-$model_name" \
    --trainer.logger.log_model False \
    --trainer.logger.offline False \
    --model_checkpoint.dirpath "/mnt/bn/liuwenzhuo-hl-data/ckpt/msun-anyres/fixed-res/$model_name" \
