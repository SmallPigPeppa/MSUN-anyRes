...
for model in "${models[@]}"; do
  ...
  python3 msun/main_sgd_swa_s4_lite.py fit \
    ...
    --trainer.logger.name "msun-swa-clip-s4-lite-$model" \
    ...
    --model_checkpoint.dirpath "/mnt/bn/liuwenzhuo-hl-data/ckpt/msun/msun-swa-clip-s4-lite/$model" \
